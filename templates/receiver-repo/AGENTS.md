...
This file is the canonical AI guidance entrypoint for a receiver runtime-role repository.
...
- Template type: runtime-role overlay template
- Primary project family: receiver-integration
- Primary runtime roles: receiver
