...
This file is the canonical AI guidance entrypoint for a frontend runtime-role repository.
...
- Primary project family: web-app or pwa
- Primary runtime roles: frontend
