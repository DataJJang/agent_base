...
This file is the canonical AI guidance entrypoint for a mockup-local family repository.
...
- Primary project family: mockup-local
- Primary runtime roles: frontend or client
