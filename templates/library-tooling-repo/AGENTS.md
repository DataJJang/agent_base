...
This file is the canonical AI guidance entrypoint for a library-tooling family repository.
...
- Primary project family: library-tooling
- Primary runtime roles: tooling
