...
This file is the canonical AI guidance entrypoint for a batch runtime-role repository.
...
- Primary project family: batch-worker
- Primary runtime roles: batch, worker
